...
class OverlayPdf extends Component {
	...
	handleMouseEnter = e => {
		if (e.target.id !== null) {
			...
			this.timeout = setTimeout(function Foo() {
				...
				if (document.getElementById('pdf-box') != null) document.getElementById('pdf-box').style.pointerEvents = 'auto';
	...
	handleMouseLeave = () => {
		...
		if (document.getElementById('pdf-box') != null) document.getElementById('pdf-box').style.pointerEvents = 'none';
	...
	render() {
		...
		return (
			<div
				className={`box-container-pdf ${hoverIndex === 'pdf-box' ? 'hovered-pdf' : ''}`}
				id="pdf-box"
				key={fileData}
				onMouseLeave={this.handleMouseLeave}
			>
				<div className="clickBox-pdf" onMouseEnter={this.handleMouseEnter} id="pdf-box" />
